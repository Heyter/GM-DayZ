...
surface.CreateFont("verdana_13_bold", {
    font = "Verdana",
    size = 13,
    weight = 700
})

surface.CreateFont("serverGuard_ownerFont", {
    font = "Calibri",
    size = 16
})
...
surface.CreateFont("corbel_16", {
    font = "Corbel",
    size = 16
})

surface.CreateFont("corbel_28", {
    font = "Corbel",
    size = 28
})

surface.CreateFont("corbel_36", {
    font = "Corbel",
    size = 36
})

surface.CreateFont("segoe.18", {
    font = "Segoe UI",
    size = 18,
    weight = 400
})

surface.CreateFont("roboto_12", {
    font = "Roboto",
    size = 12,
    weight = 400
})

surface.CreateFont("roboto.18", {
    font = "Roboto",
    size = 18,
    weight = 400
})

surface.CreateFont("roboto.15.bold", {
    font = "Roboto",
    size = 15,
    weight = 700
})

surface.CreateFont("roboto.18.bold", {
    font = "Roboto",
    size = 18,
    weight = 700
})
