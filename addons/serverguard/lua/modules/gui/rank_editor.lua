...
function category:Create(base)
    ...
    function button:DoClick()
        ...
        function complete:DoClick()
            ...
            serverguard.netstream.Start("sgNewRank", {uniqueEntry:GetValue(), nameEntry:GetValue(), tonumber(immunityEntry:GetValue()), color, image, appliedPermissions, dataTable, tonumber(targetableEntry:GetValue()), util.ParseDuration(banlimitEntry:GetValue()),})
    ...
    for unique, data in pairs(ranks) do
        ...
        function panel:OnMousePressed()
            ...
            local option = menu:AddOption("Change name", function()
                Derma_StringRequest("Rank options", "Change rank name", data.name, function(text)
                    serverguard.netstream.Start("sgChangeRankInfo", {unique, "name", SERVERGUARD.NETWORK.STRING, text})
            ...
            local option = menu:AddOption("Change immunity", function()
                Derma_StringRequest("Rank options", "Change rank immunity", data.immunity, function(text)
                    serverguard.netstream.Start("sgChangeRankInfo", {unique, "immunity", SERVERGUARD.NETWORK.NUMBER, tonumber(text)})
                end, function(text) end, "Accept", "Cancel")
            end)
            ...
            local option = menu:AddOption("Change targetable rank", function()
                Derma_StringRequest("Rank options", "Change rank's targetable rank", data.targetable, function(text)
                    serverguard.netstream.Start("sgChangeRankInfo", {unique, "targetable", SERVERGUARD.NETWORK.NUMBER, tonumber(text)})
                end, function(text) end, "Accept", "Cancel")
            end)
            ...
            local option = menu:AddOption("Change maximum ban length", function()
                Derma_StringRequest("Rank options", "Change maximum ban length (Example: 1y2w2d) ", data.banlimit, function(text)
                    serverguard.netstream.Start("sgChangeRankInfo", {unique, "banlimit", SERVERGUARD.NETWORK.NUMBER, util.ParseDuration(text)})
                end, function(text) end, "Accept", "Cancel")
            end)
            ...
            local option = menu:AddOption("Change permissions", function()
                ...
                function complete:DoClick()
                    serverguard.netstream.Start("sgChangeRankData", {unique, "Permissions", permissions})
            ...
            local option = menu:AddOption("Change color", function()
                ...
                function complete:DoClick()
                    ...
                    serverguard.netstream.Start("sgChangeRankInfo", {unique, "color", SERVERGUARD.NETWORK.COLOR, color})
            ...
            local option = menu:AddOption("Change physgun color", function()
                ...
                function complete:DoClick()
                    ...
                    serverguard.netstream.Start("sgChangeRankData", {unique, "phys_color", color})
            ...
            local option = menu:AddOption("Change image", function()
                ...
                function complete:DoClick()
                    if (image ~= "") then
                        serverguard.netstream.Start("sgChangeRankInfo", {unique, "texture", SERVERGUARD.NETWORK.STRING, image})
                    end
            ...
            local option = menu:AddOption("Remove rank", function()
                util.CreateDialog("Notice", "Are you sure you want to delete this rank?", function()
