...
function category:Create(base)
    ...
    local controls = {"tiger.base", "tiger.list", "tiger.panel", "tiger.divider", "tiger.button", "tiger.tooltip", "tiger.news"}
        ...
        for name, data in pairs(themes) do
            ...
            function panel:OnMousePressed(keyCode)
                ...
                elseif (keyCode == MOUSE_RIGHT) then
                    ...
                    if (not serverguard.themes.IsDefaultTheme(name)) then
