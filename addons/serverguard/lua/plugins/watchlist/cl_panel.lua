...
function category:Create(base)
    ...
    function category.panel.addButton:DoClick()
        ...
        function completeButton:DoClick()
            serverguard.netstream.Start("WatchlistAdd", {
                steam_id = steamIDEntry:GetText(),
                note = noteEntry:GetText()
            })
        ...
        for k, v in pairs(data) do
            ...
            function item:OnMousePressed()
                ...
                option = menu:AddOption("Delete", function()
                    util.CreateDialog("Notice", "Are you sure you want to delete this record?", function()
                ...
                option = menu:AddOption("Edit", function()
                    ...
                    function completeButton:DoClick()
                        ...
                        serverguard.netstream.Start("WatchlistEdit", {
                            steam_id = v.steam_id,
                            note = noteEntry:GetText()
                        })
