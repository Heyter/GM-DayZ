...
function category:Create(base)
    ...
    function category.list:Paint(w, h)
    end
    ...
    if (serverguard.player:HasPermission(LocalPlayer(), "Delete All Reports")) then
        ...
        function base.deleteAllButton:DoClick()
            util.CreateDialog("Notice", "Are you sure you want to delete all reports?", function()
                ...
                timer.Simple(FrameTime() * 8, function()
                    category.list:GetCanvas():InvalidateLayout()
                end)
...
function category:UpdateReports(data)
    ...
    if not (data.member) then
        ...
        function answer:DoClick()
            util.CreateDialog("Notice", "Are you sure you want to answer this report?", function()
    ...
    function remove:DoClick()
        util.CreateDialog("Notice", "Are you sure you want to delete this report?", function()
...
serverguard.netstream.Hook("sgSendReportChunk", function(data)
    ...
    local report = {
        ...
        text = text,
        time = time,
        member = member or nil,
        answered = answered or nil,
        sSteamID = staffSteamID or nil
    }
