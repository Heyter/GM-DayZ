...
SWEP.ViewModel = "models/weapons/fas2/view/smgs/mp5sd6.mdl"
SWEP.WorldModel = "models/weapons/fas2/world/smgs/mp5sd6.mdl"
...
SWEP.ShootSoundSilenced = "Firearms2_MP5SD"
...
SWEP.Hook_TranslateAnimation = function(wep, anim)
    ...
    if wep.Attachments[2].Installed == "fas2_extra_foregrip" then return anim .. "_grip" end
...
SWEP.Hook_SelectReloadAnimation = function(wep, anim)
    ...
    if wep.Attachments[2].Installed == "fas2_extra_foregrip" then return anim .. nomen .. "_grip" end
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
		...
		SoundTable = {
		{s = "Firearms2.Cloth_Movement", t = 0},
		{s = "Firearms2.MP5_BoltPull", t = 0.3},
		...
		{s = "Firearms2.MP5_BoltCatch", t = 2.9},
    ...
    ["reload_nomen_empty"] = {
		...
		{s = "Firearms2.MP5_BoltBack", t = 1.7},
		{s = "Firearms2.Cloth_Movement", t = 1.7},
		{s = "Firearms2.MP5_BoltForward", t = 1.8},
