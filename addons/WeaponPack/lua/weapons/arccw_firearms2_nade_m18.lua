...
SWEP.PrintName = "M18"
SWEP.Trivia_Class = "Smoke Grenade"
SWEP.Trivia_Desc = ""
...
SWEP.ViewModel = "models/weapons/fas2/view/explosives/m18.mdl"
SWEP.WorldModel = "models/weapons/fas2/world/explosives/m18.mdl"
...
SWEP.ShootEntity = "arccw_firearms2_m18"
...
SWEP.Animations = {
    ...
    ["pre_throw"] = {
        ...
        Time = 50/30,
        SoundTable = {
        -- {s = "Firearms2.Grip_Heavy", t = 0},
        {s = "Firearms2.M67_PinPull", t = 0.7},
        {s = "Firearms2.M67_Primer", t = 1},
        }, 
    },
    ["throw"] = {
        Source = "throw",
...
function SWEP:FireRocket(ent, vel, ang)
    ...
    src = src + EA:Right() * 1 - EA:Up() * -2 + EA:Forward() * 8
