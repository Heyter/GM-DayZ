...
SWEP.ViewModel = "models/weapons/fas2/view/rifles/ak74.mdl"
SWEP.WorldModel = "models/weapons/fas2/world/rifles/ak74.mdl"
...
SWEP.ShootSound = "Firearms2_AK74"
...
SWEP.Attachments = {
    {
        ...
        Bone = "ak_frame",
        Offset = {
            vpos = Vector(0.02, 1.7, 2.27),
            vang = Angle(0, 270, 0),
            wpos = Vector(6.25, 0.7, -6.25),
