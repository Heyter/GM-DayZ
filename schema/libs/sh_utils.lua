if (CLIENT) then
	...
	function ix.util.ScreenScaleH(n, type)
		if (type) then
	...
	ix.util.LoadedImages = ix.util.LoadedImages or { [0] = Material("icon16/cross.png") }

	function ix.util.FetchImage(id, callback, failImg, pngParameters, imageProvider)
		local loadedImage = ix.util.LoadedImages[id]
